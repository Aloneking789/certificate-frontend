...
export async function GET(req: Request) {
  try {
    ...
    const res = await fetch('https://eunous-certificate-backend.vercel.app/api/branches', { headers });
...
export async function POST(req: Request) {
  try {
    ...
    const res = await fetch('https://eunous-certificate-backend.vercel.app/api/branches', {
      method: 'POST',
      headers,
